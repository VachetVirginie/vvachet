        ...
        return {
            items: [{
                message: "JavaScript", img: "javascript.svg"
                    ...
                    {
                        message: "Symfony" , img: "symfony.svg"
                    },
                    {
                        message: "Api Platform", img: "apiPlatform.svg"
                    },
                    {
                        message: "Php", img: "php.svg"
                    },
                    {
                        message: "Docker", img: "docker.svg"
                    },
                    {
                        message: "Postman", img: "postman.svg"
                    },
                    {
